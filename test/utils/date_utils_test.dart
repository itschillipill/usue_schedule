...
void main() {
  group('DateTimeUtilsTest', () {
    test("getStartOfWeek", (){
      ...
      final _startOfWeek = DateTime(2026, 2, 16); // Понедельник 16 февраля 2026 года
    ...
    test('getEndOfWeek', () {
      final date = DateTime(2026, 2, 19); // Четверг 19 февраля 2026 года
      // ignore: no_leading_underscores_for_local_identifiers
      final _endOfWeek = DateTime(2026, 2, 22); // Воскресенье 22 февраля 2026 года
    ...
    test('formatDate', () {
      ...
      final formattedDateWithoutWeekDay = DateTimeUtils.formatDate(date, showWeekday: false);
    ...
    test("isToday", (){
      ...
      expect(DateTimeUtils.isToday(date.subtract(const Duration(days: 1))), false);
